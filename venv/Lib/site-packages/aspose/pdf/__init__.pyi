...
class Cells:
    ...
    @overload
    def add(self, text_fragment: aspose.pdf.text.TextFragment) -> aspose.pdf.Cell:
        '''Add cell to collection.
        
        :param text_fragment: The text fragment for cell.
        :returns: The new cell'''
        ...
...
class Document:
    ...
    @overload
    def __init__(self, input: Any, cert_options: aspose.pdf.security.CertificateEncryptionOptions):
        '''Initialize new Document instance from the  stream.
        
        :param input: Input stream object, corresponding pdf is password protected.
        :param cert_options: The certificate encryption options.'''
        ...
    
    @overload
    def __init__(self, input: Any, cert_options: aspose.pdf.security.CertificateEncryptionOptions, is_managed_stream: bool):
        '''Initialize new Document instance from the  stream.
    ...
    @overload
    def __init__(self, filename: str, cert_options: aspose.pdf.security.CertificateEncryptionOptions):
    ...
    @overload
    def __init__(self, filename: str, cert_options: aspose.pdf.security.CertificateEncryptionOptions, is_managed_stream: bool):
        '''Initializes new instance of the :class:`Document` class for working with encrypted document.
    ...
    @property
    def enable_notification_logging(self) -> bool:
        '''Gets or sets a value indicating whether to enable the logging of notifications.'''
        ...
    
    @enable_notification_logging.setter
    def enable_notification_logging(self, value: bool):
        ...
    ...
    class MergeOptions:
          ...
          def use_disk_buffer(self) -> bool:
              '''If this option used then destination document will be saved
                 on disk periodically and further concatenation will appllied to it as incremental updates.
          ...
          def concatenation_packet_size(self) -> int:
              '''Number of documents concatenated before new incremental update
                 was made during concatenation when UseDiskBuffer is set to True.
...
class License:
    ...
    @property
    def license_info(self) -> aspose.pdf.LicenseInfo:
...
class LicenseInfo:
    ...
    @property
    def subscription_expiry(self) -> datetime.datetime:
    ...
    @property
    def license_expiry(self) -> datetime.datetime:
...
class XImage:
    ...
    def get_alternative_text(self, page: aspose.pdf.Page) -> None:
        '''Returns a list of strings with Alternative Text for an XImage.
        
        :param page: The page where XImage is located.
        :returns: List of strings with Alternative Text for an XImage.'''
        ...
    
    def try_set_alternative_text(self, alternative_text: str, page: aspose.pdf.Page) -> bool:
        ...
